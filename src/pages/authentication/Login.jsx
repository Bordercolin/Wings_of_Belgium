...
import Forms from "../../components/global/forms/Loginforms";
import design from "./css/auth.module.css";
  ...
  return (
    <>
      ...
      <div className={design.container}>
        <div className={design.logoWrapper}>
          <svg
        ...
        />
        <p>
          <a href="/register">Nog geen account? Maak er hier een aan</a>
        </p>
      </div>
    </>
  );
